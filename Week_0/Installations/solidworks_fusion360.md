...
## 🥇 Primary Option: SolidWorks

**SolidWorks is the highly recommended and primary CAD software for this summer camp.**

Please download and install SolidWorks (and Ansys for simulations) using the provided IIT BHU links.

### SolidWorks & Ansys Download Links
- 📥 **[Download SolidWorks & Ansys (IIT BHU OneDrive Share)](https://iitbhuacin-my.sharepoint.com/:f:/g/personal/aryan_kumar_mec21_iitbhu_ac_in/Ep6X02My5qBElme6-oiZU1cBbAmdY0HwXmRvq2fQCty0lQ?e=voDTzG)**
- 🎥 **[Installation and Setup Tutorial Video (How to download)](https://iitbhuacin-my.sharepoint.com/:v:/g/personal/raut_sahilprakash_mec23_iitbhu_ac_in/EUwY-9khU49Cn9lo58aDW-8BOCovOxdN8bpj5V0Rg2az0g?e=OgcENc&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)**

> **Note:** If you are unable to install SolidWorks (e.g., you are on macOS where it is not natively supported), please fall back to **Autodesk Fusion 360** below.

---

## 🥈 Fallback Option: Autodesk Fusion 360

*Only install this if SolidWorks is not working for you, or if you are using a Mac.*

A comprehensive guide to the installation of Autodesk Fusion 360 on Windows, macOS, and Ubuntu 22.04.
...
### 🍎 macOS (Recommended natively on Mac, UTM for other tools)
